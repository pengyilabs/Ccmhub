// Functional action icons for interactive elements
...
export function SettingsIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    ...
    >
      <circle cx="12" cy="12" r="3" />
      <path d="M12 1v6m0 6v6m5.2-14.8 4.2 4.2m-4.2 9.6 4.2 4.2M1 12h6m6 0h6M2.8 17.8l4.2-4.2m9.6-4.2 4.2-4.2M2.8 6.2l4.2 4.2m9.6 9.6 4.2 4.2" />
    </svg>
  );
}
