      ...
      <div className="w-full max-w-[480px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Sign in to manage your restaurant outlets and digital services
          </p>
        </div>
        ...
        <Card className="p-8 border border-gray-200 shadow-xl bg-white rounded-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-[#FDD42B] hover:opacity-90 text-gray-900 mt-6 h-11 rounded-[8px] shadow-lg font-semibold"
            >
              Sign in
            </Button>
          </form>
